...
const Hero = () => {
    return (
        <Box backgroundColor="#FFA8E2" w="100%" h="70vh" position="relative">
            <Image src="https://cdn.shopify.com/s/files/1/0472/5705/9496/files/Bath_Bomb_-_Product-4_-_nobg_1.png?v=1610055851.jpg" h="100%" m="auto" objectFit="contain"
